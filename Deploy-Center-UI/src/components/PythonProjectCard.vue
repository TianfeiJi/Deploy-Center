    ...
    <q-card-section >
      ...
      <div class="row items-center q-mt-sm">
        ...
        <div class="col-auto flex items-center justify-end">
          <el-tag
            :closable="false"
            :type="pythonProject.status === 'running' ? 'success' : 'danger'"
            effect="light"
          >
            {{ pythonProject.status === 'running' ? '运行中' : '待部署' }}
          </el-tag>
        </div>
      </div>
    </q-card-section>
...
const viewPythonProjectDetail = () => {
  tableData.value = [
    ...
    { label: '状态', key: 'status', value: props.pythonProject.status, editable: true },
